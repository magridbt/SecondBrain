-- ============================================================================
-- FIX SEARCH - Correção da busca semântica
-- Execute este SQL no Supabase SQL Editor
-- Data: 2026-02-14
-- ============================================================================

-- ============================================================================
-- 1. CORRIGIR search_teachings (adicionar filter_language)
-- ============================================================================
...
-- ============================================================================
-- 2. CORRIGIR search_teachings_optimized (fix: source_id, não teaching_sources_id)
-- ============================================================================
...
FROM pg_proc
WHERE proname IN ('search_teachings', 'search_teachings_optimized');

-- ============================================================================
-- 4. TESTE RÁPIDO - Verificar que há chunks no banco
-- ============================================================================
SELECT COUNT(*) as total_chunks FROM document_chunks WHERE embedding IS NOT NULL;
SELECT COUNT(*) as total_indexed_docs FROM documents WHERE status = 'indexed' AND deleted_at IS NULL;
