...
```python
# Input
squad_path: str  # "squads/copy/"

# Output
{
  "exists": true,
  "components": {
    "agents": {"count": 22, "files": ["gary-halbert.md", ...]},
...
```python
# Input
file_path: str  # "squads/copy/agents/gary-halbert.md"
...
```python
# Input
agent_file: str  # "squads/copy/agents/gary-halbert.md"
...
# Output
{
  ...
  "file_naming": {
    "agents": {"valid": ["gary-halbert.md"], "invalid": []},
