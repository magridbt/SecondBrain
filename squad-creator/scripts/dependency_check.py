...
Usage:
    python scripts/dependency_check.py squads/copy/
    python scripts/dependency_check.py squads/copy/ --output json
    python scripts/dependency_check.py squads/copy/ --strict  # Include external refs
"""
...
KNOWN_SQUADS = {
    "copy", "legal", "mmos", "data", "design", "books", "ralph",
    "compound", "creator-os", "cybersecurity", "db-sage", "etl",
    "hr", "hybrid-ops-squad", "innerlens", "monitor", "multi-lens-framework",
    "squad-creator", "storytelling", "tools", "LegalSquad"
}
