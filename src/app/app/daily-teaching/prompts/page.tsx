...
export default function PromptsPage() {
  ...
  const loadPrompts = async () => {
    setLoading(true)
    try {
      const response = await fetch('/api/prompts?includePublic=false')
  ...
  const handleSave = async () => {
    ...
    try {
      ...
      const body = editingPrompt
        ? { id: editingPrompt.id, ...formData, conversation_starters: starters }
        : { ...formData, conversation_starters: starters }
  ...
  const handleCopySlug = async (prompt: CustomPrompt) => {
    try {
      // If public, copy share URL. Otherwise copy just the slug command
      ...
      <header className="bg-white/80 dark:bg-gray-900/80 backdrop-blur-xl border-b border-sage-100/50 dark:border-sage-800/30 px-6 py-4">
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-4">
            <button
              onClick={() => router.push('/app/daily-teaching')}
            ...
            <div className="flex items-center gap-3">
              ...
              <div>
                <h1 className="font-bold text-gray-800 dark:text-gray-100 tracking-tight">My Prompts</h1>
          ...
          {loading ? (
            ...
            <div className="text-center py-20 animate-fadeIn">
              ...
              <p className="text-gray-600 dark:text-gray-400 mb-6 max-w-md mx-auto">
                Prompts are custom instructions that define how messages will be generated.
                Similar to ChatGPT GPTs.
              </p>
              <button
                onClick={openCreateModal}
            ...
            <div className="p-6 overflow-y-auto max-h-[calc(90vh-140px)] space-y-6">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div>
                  ...
                  <input
                    ...
                    placeholder="E.g.: Motivational Message"
                    maxLength={100}
                ...
                <div>
                  ...
                  <input
                    ...
                    placeholder="E.g.: Creates motivational messages for the day"
                    maxLength={200}
                    className="w-full px-4 py-3 border border-sage-100/50 dark:border-sage-800/30 bg-white dark:bg-gray-800 text-gray-900 dark:text-gray-100 rounded-xl focus:ring-2 focus:ring-sage-400 focus:border-transparent outline-none transition-all"
                  />
              ...
              <div>
                ...
                <textarea
                  ...
                  placeholder={`Example:
You are a spiritual assistant that creates inspiring messages.

RULES:
1. Use a welcoming and loving tone
2. Stay faithful to the teachings
3. Be concise but profound

FORMAT:
- Title (1 line)
- Message (2-3 paragraphs)
- Reflection of the day`}
              ...
              <div>
                ...
                <p className="text-xs text-gray-500 dark:text-gray-400 mb-3">
                  Add up to 4 example prompts to help users get started. Similar to ChatGPT GPTs.
                </p>
                <div className="space-y-2">
                  {formData.conversation_starters.map((starter, index) => (
                    <input
                      ...
                      placeholder={`Example ${index + 1}: E.g.: "Create a message about gratitude"`}
